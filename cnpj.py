...
def calcula_digito(cnpj, digito):
    ...
    return '{}{}'.format(novo_cnpj, digito)
...
def gerador_cnpj():
    ...
    quarto_bloco = '0001'
    inicio_cnpj = '{}{}{}{}{}00'.format(primeiro_digito, segundo_digito, segundo_bloco, terceiro_bloco, quarto_bloco)
...
def formata(cnpj):
    cnpj = remover_caracter(cnpj)
    formatado = '{}.{}.{}/{}-{}'.format(cnpj[:2], cnpj[2:5], cnpj[5:8], cnpj[8:12], cnpj[12:14])
    return formatado